...
import { collection, getDocs, deleteDoc, setDoc, getDoc } from  "firebase/firestore";
  ...
  return (
    ...
    alignItems="center" gap={2}>
      <Modal open={open} onClose={handleClose}>
        ...
        width={400} backgroundColor="white" border="2px solid #000"
      ...
      <Box border="1px solid #333">
        <Box width="800px" height="100px" display="flex" backgroundColor="#ADD8E6" alignItems="center" justifyContent="center">
          <Typography variant="h2" color="#333">Inventory Items</Typography>
        </Box>
      <Stack width="800px" height="300px" spacing={2} overflow="auto">
        {
          inventory.map(({name, quantity}) => (
            <Box key={name} width="100%" minHeight="150px" display="flex" alignItems="center" justifyContent="space-between"
            padding={5}>
